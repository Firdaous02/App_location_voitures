...
class AdminProfileUi(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(210, 70, 381, 71))
...
"font: 14pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Bienvenue Admin"))
        self.label_2.setText(_translate("Dialog", "Choisie un service"))
        self.login.setText(_translate("Dialog", "Voir tous les managers"))
        self.login_2.setText(_translate("Dialog", "Ajouter un manager"))
        self.login_3.setText(_translate("Dialog", "Modifier un manager"))
        self.login_4.setText(_translate("Dialog", "Supprimer un manger"))
